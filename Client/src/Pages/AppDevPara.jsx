  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-orange-50 py-10 px-4 md:px-10">
      ...
      <div className="max-w-4xl mx-auto space-y-8 text-gray-800">
        ...
        <p>
          Whether you need a native, hybrid, or cross-platform app, we have the
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            ...
            use Swift for iOS and Kotlin for Android to create high-performance,
            feature-rich apps.
          </li>
          <li>
          ...
          <li>
            <span className="font-semibold">Hybrid App Development:</span> Built
            with Ionic and Cordova, our hybrid apps offer speed, flexibility,
            and cost efficiency.
          </li>
          <li>
            <span className="font-semibold">App UI/UX Design:</span> We design
            engaging, user-friendly interfaces that enhance user experience and
            functionality.
          </li>
          <li>
            <span className="font-semibold">
            ...
            Rigorous testing ensures performance, security, and stability across
            all devices.
          </li>
          <li>
          ...
          <li>
            <span className="font-semibold">App Integration:</span> We integrate
            APIs, payment gateways, and backend services to extend your app’s
            capabilities.
          </li>
        </ul>
